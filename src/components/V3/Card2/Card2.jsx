...
const Card2 = () => {
  return (
    <div className="bg-[#161514] text-[#FFFFFF] overflow-hidden rounded-3xl relative w-full">
      <div className="md:flex md:flex-row-reverse py-16 gap-5">
        ...
        <div className="w-full md:w-[55%] pr-8">
          <div className="rounded-r-[20px] bg-white/30 backdrop-blur-3xl ">
            <img src={card2Pic} alt="cardPic" className="h-full w-full" />
          </div>
        </div>
      </div>
      <div className="w-[117px] h-[237px] bg-gradient-to-r from-[#EB008B]/80 to-[#F9EC31]/80 blur-3xl rounded-full absolute top-10 md:top-[330px] -right-16 "></div>
    </div>
  );
};
